...
export const update = asyncHandler(async (req: Request, res: Response) => {
  const category = await adminService.updateCategory(req.params.id, req.body as UpdateCategoryInput);
...
export const activate = asyncHandler(async (req: Request, res: Response) => {
  const category = await adminService.activateCategory(req.params.id);
