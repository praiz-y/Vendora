...
import { archiveReasonSchema, createCategorySchema, listCategoriesQuerySchema, updateCategorySchema } from "../categories.validation";
...
router.post("/:id/archive", validate(archiveReasonSchema), adminController.archive);
